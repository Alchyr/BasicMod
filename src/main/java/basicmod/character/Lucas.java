...
public class Lucas extends CustomPlayer {
    //Stats
    public static final int ENERGY_PER_TURN = 5;
    public static final int MAX_HP = 420;
    public static final int STARTING_GOLD = 69;
    public static final int CARD_DRAW = 7;
    public static final int ORB_SLOTS = 0;

    //Strings
    private static final String ID = makeID("Lucas"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Lucas(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
